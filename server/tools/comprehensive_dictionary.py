"""
Comprehensive CLIF Data Dictionary
Includes all variables from all CLIF tables
"""

CLIF_DATA_DICTIONARY = {
    ...
    "vitals": {
        ...
        "vital_category": {
            ...
            "type": "categorical",
            "values": ["Heart Rate", "Systolic Blood Pressure", "Diastolic Blood Pressure", 
    ...
    "labs": {
        ...
        "lab_category": {
            ...
            "type": "categorical",
            "values": ["Hemoglobin", "White Blood Cell Count", "Platelet Count", "Creatinine",
                      "Glucose", "Sodium", "Potassium", "Lactate"]
        },
        "lab_value": {
    ...
    "respiratory_support": {
        ...
        "device_category": {
            ...
            "type": "categorical",
            "values": ["None", "Nasal Cannula", "High Flow Nasal Cannula", 
    ...
    "medication_administration": {
        ...
        "medication_name": {
            ...
            "type": "categorical",
            "examples": ["Propofol", "Fentanyl", "Norepinephrine", "Vancomycin", 
                        "Piperacillin-Tazobactam", "Heparin", "Insulin", "Furosemide"]
        },
        "medication_category": {
            "description": "Class of medication",
            "type": "categorical",
            "values": ["Sedative", "Analgesic", "Vasopressor", "Antibiotic", 
                      "Anticoagulant", "Hormone", "Diuretic"]
        },
        "route": {
